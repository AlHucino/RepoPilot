"""Deterministic RepoPilot eval suites.
...
from openharness.runlog.trace import TraceRecorder, summarize_run
...
def run_local_eval(cwd: str | Path) -> dict[str, Any]:
    """Generate deterministic trace runs that validate RepoPilot plumbing."""
    ...
    cases = (
        {
            ...
            "problem_statement": "Validate that RepoPilot can import a public benchmark instance shape.",
        },
        {
