"""RepoTrace AgentOps trace and eval tests."""
...
from openharness.agentops.trace import export_run_markdown, list_runs, load_run_events
...
def test_local_eval_writes_scorecard_and_trace_runs(tmp_path: Path) -> None:
    ...
    assert (tmp_path / ".repotrace" / "evals" / "local-scorecard.json").exists()
